...
**(Related work is being continuously updated...)**
...
24. 2026-EDBT DCSR: A Fast Data Structure with Leaf-Oriented Locks for Streaming Graph Processing[[pdf]](https://openproceedings.org/2026/conf/edbt/paper-246.pdf)
25. 2026-SIGMOD Bw-Graph: An Efficient Graph Storage System Harmonizing Topology-Aware Tree with Paged CSR[[pdf]](https://dl.acm.org/doi/10.1145/3802025)
...
24. 2026-TACO WSGraph A Framework for Tackling Redundant and Irregular Data Access in Streaming Graph Processing[[pdf]](https://dl.acm.org/doi/10.1145/3803023)
...
7. 2023-SPEED: Streaming Partition and Parallel Acceleration for Temporal Interaction Graph Embedding[[pdf]](https://arxiv.org/abs/2308.14129)[[code]](https://github.com/chenxi1228/SPEED)
8. 2023-TACO RACE: An Efficient Redundancy-aware Accelerator for Dynamic Graph Neural Network[[pdf]](https://dl.acm.org/doi/10.1145/3617685)
9. 2023-ICLR Do We Really Need Complicated Model Architectures for Temporal Networks?[[pdf]](https://arxiv.org/abs/2302.11636)
10. 2024-ASPLOS TGLITE: A Lightweight Programming Framework for Continuous-Time Temporal Graph Neural Networks[[pdf]](https://charithmendis.com/assets/pdf/asplos24-tglite.pdf)[[code]](https://github.com/ADAPT-uiuc/tglite)
11. 2024-ICDE Learning Time-aware Graph Structures for Spatially Correlated Time Series Forecasting[[pdf]](https://arxiv.org/abs/2312.16403)
...
15. 2024-KDD LLM4DyG: Can Large Language Models Solve Spatial-Temporal Problems on Dynamic Graphs?[[pdf]](https://arxiv.org/abs/2310.17110)
16. 2025-VLDB TEAM: Topological Evolution-Aware Framework for Traffic Forecasting[[pdf]](https://www.vldb.org/pvldb/vol18/p265-kieu.pdf)
17. 2025-KDD TIDFormer: Exploiting Temporal and Interactive Dynamics Makes A Great Dynamic Graph Transformer[[pdf]](https://arxiv.org/abs/2506.00431)

**dynamic GNN training**
1. 2019-KDD Predicting Dynamic Embedding Trajectory in Temporal Interaction Networks[[pdf]](https://arxiv.org/abs/1908.01207)
2. 2021-SC Efficient Scaling of Dynamic Graph Neural Networks[[pdf]](https://arxiv.org/abs/2109.07893)
3. 2022-CIMK PlatoGL: Effective and Scalable Deep Graph Learning System for Graph-enhanced Real-Time Recommendation[[pdf]](https://dl.acm.org/doi/10.1145/3511808.3557084)
4. 2022-LLSWC Bottleneck Analysis of Dynamic Graph Neural Network Inference on CPU and GPU[[pdf]](https://arxiv.org/abs/2210.03900)
5. 2022-DSFAA IncreGNN: Incremental Graph Neural Network Learning by Considering Node and Parameter Importance[[pdf]](https://dl.acm.org/doi/10.1007/978-3-031-00123-9_59)
6. 2023-VLDB NeutronStream: A Dynamic GNN Training Framework with Sliding Window for Graph Streams[[pdf]](https://www.vldb.org/pvldb/vol17/p455-chen.pdf)
7. 2023-VLDB Decoupled Graph Neural Networks for Large Dynamic Graphs[[pdf]](https://www.vldb.org/pvldb/vol16/p2239-zheng.pdf)
8. 2023-SIGMOD Orca: Scalable Temporal Graph Neural Networks Training with Theoretical Guarantees[[pdf]](https://dl.acm.org/doi/10.1145/3588737)
...
16. 2024-ICDE PlatoD2GL: An Efficient Dynamic Deep Graph Learning System for Graph Neural Networks Training on Billion-Scale Graphs[[pdf]](https://ieeexplore.ieee.org/document/10597951)
17. 2024-HPCA Enabling Large Dynamic Neural Network Training with Learning-based Memory Management[[pdf]](https://ieeexplore.ieee.org/document/10476398)
18. 2025-SIGMOD SWASH: A Flexible Communication Framework with Sliding Window-Based Cache Sharing for Scalable DGNN Training[[pdf]](https://dl.acm.org/doi/10.1145/3725360)[[code]](https://songzhen0210.github.io/)
19. 2025-IJCAI Efficient Dynamic Graph Learning with Refined Batch Parallel Training[[pdf]](https://dl.acm.org/doi/10.24963/ijcai.2025/312)
20. 2025-HPCA I-DGNN: A Graph Dissimilarity-based Framework for Designing Scalable and Efficient DGNN Accelerators[[pdf]](https://ieeexplore.ieee.org/document/10946772)
21. 2025-SIGMOD SWIFT: Enabling Large-Scale Temporal Graph Learning on a Single Machine[[pdf]](https://dl.acm.org/doi/10.1145/3749184)
