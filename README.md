...
3. A survey of distributed graph algorithms on massive graphs
...
7. A survey on graph processing accelerators: Challenges and opportunities
8. Hardware acceleration for knowledge graph processing: Challenges & recent developments
9. Practice of streaming processing of dynamic graphs: Concepts, models, and systems
10. Revisiting the design of in-memory dynamic graph storage
11. BYO: A unified framework for benchmarking large-scale graph containers
