...
3. KONECT (The Koblenz Network Collection)
...
4. LAW / WebGraph (Large Web Graph)
...
8. GraphChallenge / MIT Challenge
...
9. LDBC (Linked Data Benchmark Council)
...
10. Large-Scale Internet Graphs (Common Crawl Web Graph)
